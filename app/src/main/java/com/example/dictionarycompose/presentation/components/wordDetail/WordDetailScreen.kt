package com.example.dictionarycompose.presentation.components.wordDetail
...
import com.example.dictionarycompose.presentation.theme.ui.*
    ...
    Column(modifier = Modifier
        ...
        LazyColumn(
            ...
            items(state.wordInfoList[selectedWordIndex].meanings) { meaning: Meaning ->
                WordMeaningItemComposable(meaning)
